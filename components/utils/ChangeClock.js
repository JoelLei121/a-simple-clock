...
export default function ChangeClock({initTime={ hour: 1, minute: 10, second: 30}, scale=1, handleConfirm, handleCancel}) {
          ...
          onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={stopDragging} onMouseLeave={stopDragging}>
            ...
            <div style={{display:"flex", flexDirection:"column",alignContent:"center",alignItems:"center"}}>
              ...
              <div style={{justifyItems:"center"}}>
                <button className={styles.button} style={{backgroundColor:"#3aac3c"}} onClick={()=>handleConfirm(time)}>确认修改</button>
                <button className={styles.button} style={{backgroundColor:"#c9295e"}} onClick={()=>handleCancel()}>取消</button>
              </div>
            </div>
        </div>
    )
